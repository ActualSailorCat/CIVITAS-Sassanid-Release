...
VALUES	('LEADER_CVS_KAWAD_I',		'Unique',		'COLOR_PLAYER_CVS_SASANIAN_CVS_KAWAD_I_PRIMARY',	'COLOR_PLAYER_CVS_SASANIAN_CVS_KAWAD_I_SECONDARY', 		'COLOR_PLAYER_WHITE_TEXT');	

INSERT INTO Colors 
		(Type, 														Red, 	Green, 	Blue, 	Alpha)
VALUES	('COLOR_PLAYER_CVS_SASANIAN_CVS_KAWAD_I_PRIMARY', 			0.518,	0.392,	0.596,	1),
		('COLOR_PLAYER_CVS_SASANIAN_CVS_KAWAD_I_SECONDARY', 		0.890,	0.886,	0.565,	1);*/
-----------------------------------------------		
-- BackGround Art		
-----------------------------------------------			
